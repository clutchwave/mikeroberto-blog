...
def main():
    ...
    print(f"  - aligncenter, alignleft, alignright classes preserved for CSS styling")
    print(f"  - Add wordpress-caption-styles.css to your theme for proper styling")
    print(f"\nNext steps:")
    ...
    print(f"  4. Add wordpress-caption-styles.css for image alignment")
